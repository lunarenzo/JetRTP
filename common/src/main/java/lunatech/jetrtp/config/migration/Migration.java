package lunatech.jetrtp.config.migration;
...
public final class Migration implements ConfigurationTransformation {
    ...
    public static final class Builder {
         ...
         *
         * <p>JetRTP, move {@code language} into {@code settings}, producing {@code settings.language}:
         ...
         *
         * <p>JetRTP, move {@code old-key} to {@code section.new-key}:
